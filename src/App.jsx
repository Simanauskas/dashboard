...
const HEALTH_DATA = {
  ...
  daily: [
    ...
    {date:"2026-08-24",hrv:101,rhr:42,spo2:99,resp:12.0,sleep_score:95},
    {date:"2026-08-25",hrv:102,rhr:43,spo2:97,resp:12.0,sleep_score:88},
    {date:"2026-08-26",hrv:109,rhr:43,spo2:96,resp:12.0,sleep_score:88},
    {date:"2026-08-27",hrv:81,rhr:42,spo2:92,resp:11.0,sleep_score:88},
    {date:"2026-08-28",hrv:43,rhr:47,spo2:96,resp:13.0,sleep_score:null},
    {date:"2026-08-29",hrv:83,rhr:49,spo2:94,resp:14.0,sleep_score:null},
    ...
    {date:"2026-09-03",hrv:32,rhr:67,spo2:94,resp:16.0,sleep_score:null},
    {date:"2026-09-04",hrv:95,rhr:42,spo2:95,resp:11.0,sleep_score:95},
    {date:"2026-09-05",hrv:125,rhr:43,spo2:98,resp:13.0,sleep_score:null},
    {date:"2026-09-06",hrv:111,rhr:41,spo2:94,resp:13.0,sleep_score:null},
    ...
    {date:"2026-09-11",hrv:103,rhr:38,spo2:96,resp:11.0,sleep_score:95},
    {date:"2026-09-12",hrv:55,rhr:40,spo2:98,resp:11.0,sleep_score:null},
    {date:"2026-09-13",hrv:105,rhr:38,spo2:96,resp:11.0,sleep_score:null},
    {date:"2026-09-14",hrv:124,rhr:39,spo2:94,resp:11.0,sleep_score:95},
    ...
    {date:"2026-09-19",hrv:39,rhr:56,spo2:96,resp:14.0,sleep_score:null},
    {date:"2026-09-20",hrv:57,rhr:41,spo2:93,resp:12.0,sleep_score:88},
  ...
  sleep: [
    ...
    {date:"2026-08-24",deep:106,rem:78,light:251,awake:0},
    {date:"2026-08-25",deep:81,rem:99,light:250,awake:9},
    {date:"2026-08-26",deep:93,rem:105,light:280,awake:5},
    {date:"2026-08-27",deep:93,rem:126,light:258,awake:6},
    {date:"2026-08-28",deep:133,rem:22,light:331,awake:50},
    {date:"2026-08-29",deep:80,rem:49,light:386,awake:7},
    ...
    {date:"2026-09-03",deep:32,rem:0,light:200,awake:99},
    {date:"2026-09-04",deep:103,rem:101,light:397,awake:0},
    {date:"2026-09-05",deep:54,rem:88,light:354,awake:4},
    {date:"2026-09-06",deep:77,rem:26,light:173,awake:7},
    ...
    {date:"2026-09-11",deep:154,rem:151,light:245,awake:1},
    {date:"2026-09-12",deep:142,rem:104,light:293,awake:12},
    {date:"2026-09-13",deep:66,rem:83,light:275,awake:6},
    {date:"2026-09-14",deep:123,rem:81,light:348,awake:5},
    ...
    {date:"2026-09-19",deep:76,rem:5,light:199,awake:66},
    {date:"2026-09-20",deep:165,rem:152,light:281,awake:2},
...
"24186161221": {
    date:"2026-08-31", name:"Hyrox circle", type:null,
    totalTime:2539, avgHR:137, maxHR:173,
    description:``,
    photos:[],
    laps:[{i:1,t:598,avgHr:102,maxHr:133,dist:610,role:"run"},{i:2,t:128,avgHr:133,maxHr:154,dist:79,role:"station"},{i:3,t:16,avgHr:148,maxHr:151,dist:4,role:"station"},{i:4,t:126,avgHr:154,maxHr:164,dist:393,role:"station"},{i:5,t:18,avgHr:157,maxHr:163,dist:5,role:"station"},{i:6,t:133,avgHr:152,maxHr:164,dist:62,role:"station"},{i:7,t:19,avgHr:156,maxHr:162,dist:8,role:"station"},{i:8,t:124,avgHr:159,maxHr:170,dist:398,role:"station"},{i:9,t:127,avgHr:118,maxHr:170,dist:35,role:"station"},{i:10,t:561,avgHr:158,maxHr:173,dist:308,role:"station"},{i:11,t:408,avgHr:141,maxHr:163,dist:330,role:"station"},{i:12,t:130,avgHr:151,maxHr:159,dist:7,role:"station"},{i:13,t:149,avgHr:153,maxHr:163,dist:313,role:"station"}],
  },
"24244349642": {
...
"24428021040": {
    date:"2026-09-20", name:"Hyrox circle ", type:null,
    totalTime:3786, avgHR:130, maxHR:178,
    description:``,
    photos:[],
...
"Tennis V2","2026-09-22 10:01:16","false","Vainius Sodeika🎾sparring","0,83","514","01:35:07","96","146","0,9","23","--","114:09","--","--","--","--","--","--","38,44","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:10:49","01:35:07","--","--"
"Strength Training","2026-09-21 18:49:52","false","Strength","0,00","369","00:47:50","111","195","2,4","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:47:50","00:47:50","--","--"
"Tennis V2","2026-09-21 14:34:11","false","Povilas Lengvinas🎾5:7 1:6","0,91","624","01:27:06","109","148","2,0","28","--","96:20","--","--","--","--","--","--","37,78","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:12:14","01:27:06","--","--"
"Indoor Running","2026-09-20 10:02:47","false","Hyrox circle ","8,04","698","01:03:05","130","178","4,2","112","--","7:50","--","--","--","--","--","--","108,70","7,9","8,1","311","--","--","--","--","--","--","--","--","--","No","--","12","--","--","--","--","--","00:45:12","01:11:46","--","--"
"Cycling","2026-09-18 12:37:23","false","Vilnius Cycling","6,90","150","00:25:40","91","119","0,4","--","--","3:43","--","--","--","77","68","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:25:14","05:11:35","--","--"
"Other","2026-09-18 09:37:50","false","Sauna","0,00","41","00:10:00","80","96","0,1","0","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:10:00","00:10:00","--","--"
"Tennis V2","2026-09-18 08:00:47","false","Tennis","0,77","685","01:26:37","114","159","2,4","26","--","113:22","--","--","--","--","--","--","34,05","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:10:47","01:26:37","--","--"
"Running","2026-09-17 20:54:18","false","Vilnius Running","7,10","457","00:40:15","130","139","2,4","173","--","5:40","--","--","--","39","32","--","101,74","7,3","7,6","274","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:40:15","00:40:15","--","--"
"Cycling","2026-09-17 08:39:18","false","Vilnius Cycling","5,67","159","00:25:48","93","124","0,5","--","--","4:32","--","--","--","88","50","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:23:47","08:45:26","--","--"
"Other","2026-09-16 18:09:05","false","Sauna","0,00","73","00:20:30","75","135","0,3","0","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:20:30","00:20:30","--","--"
"Indoor Running","2026-09-16 16:33:58","false"," Compromised running + circle 30min","4,27","641","00:55:01","137","173","3,7","83","--","12:53","--","--","--","--","--","--","87,94","12,7","10,8","395","--","--","--","--","--","--","--","--","--","No","--","10","--","--","--","--","--","00:31:44","01:13:42","--","--"
"Running","2026-09-15 18:48:53","false","Z2 1h","12,11","845","01:06:28","132","143","3,2","176","--","5:29","--","--","--","61","55","--","103,65","7,1","7,6","270","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","01:06:27","01:06:31","--","--"
"Cycling","2026-09-15 09:37:47","false","Vilnius Cycling","4,67","115","00:19:40","91","119","0,4","--","--","4:12","--","--","--","60","34","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:17:20","07:14:35","--","--"
"Cycling","2026-09-14 21:01:28","false","Vilnius Cycling","4,99","102","00:17:10","91","112","0,4","--","--","3:26","--","--","--","27","94","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:16:59","00:17:23","--","--"
...
"Running","2026-09-10 15:53:37","false","Z2 60min","10,83","762","00:57:42","132","144","3,1","178","--","5:19","--","--","--","79","72","--","105,20","8,0","8,4","249","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:57:42","00:57:42","--","--"
"Running","2026-09-09 19:55:06","false","Corfu Z1 run","3,72","268","00:24:03","115","124","1,8","167","--","6:28","--","--","--","12","14","--","92,60","9,2","8,5","277","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:24:03","00:24:03","--","--"
"Strength Training","2026-09-09 10:22:55","false","Strength","0,00","134","00:57:27","66","123","0,1","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:57:27","00:57:27","--","--"
"Lap Swimming","2026-09-09 09:57:58","false","Pool Swim","0,32","78","00:08:02","107","126","0,6","--","--","19:51","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","2","--","--","--","--","--","00:06:24","00:24:20","--","--"
"Lap Swimming","2026-09-07 09:59:49","false","Pool Swim","0,44","123","00:23:15","82","136","0,4","--","--","20:06","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","2","--","--","--","--","--","00:08:47","00:26:34","--","--"
"Strength Training","2026-09-07 08:37:28","false","Strength","0,00","240","00:58:14","81","120","0,3","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:58:14","00:58:14","--","--"
...
"Cycling","2026-08-31 07:39:23","false","Vilnius Cycling","6,91","145","00:27:18","88","116","0,4","--","--","3:57","--","--","--","65","61","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:26:18","09:59:48","--","--"
"Indoor Running","2026-08-31 19:00:31","false","Hyrox circle","2,55","529","00:42:19","137","173","3,3","77","--","16:35","--","--","--","--","--","--","85,32","15,5","10,3","452","--","--","--","--","--","--","--","--","--","No","--","13","--","--","--","--","--","00:26:51","00:45:52","--","--"
"Tennis V2","2026-08-30 11:31:08","false","Tennis sparring with Arturas J","0,80","542","01:32:31","98","139","1,1","26","--","116:33","--","--","--","--","--","--","33,24","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","00:12:20","01:32:31","--","--"
...
"Running","2026-08-27 09:02:59","false","Vilnius - 16x400m Speed","10,40","772","00:56:09","144","174","3,7","157","--","5:24","--","--","--","35","36","--","114,75","6,1","6,9","302","--","--","--","--","--","--","--","--","--","No","--","34","--","--","--","--","--","00:54:59","00:56:09","--","--"
"Sky Diving","2026-08-25 19:50:04","false","Skydive Kaunas 3 jumps","0,00","0","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","--","No","--","1","--","--","--","--","--","--","--","--","--"
...
const LAST_RUN  = "2026-09-25T14:49:00Z";
const LAST_DATA = "2026-09-25T14:49:00Z";
...
const SCHEDULE = [
  ...
  { week:4, label:"Sep 28–Oct 4", theme:"Base I · Benchmarks", days:[
    ...
    { date:"2026-09-29", dow:"TUE", label:"Sep 29", sessions:[{type:"tennis",cal:true,text:"Padel 🎾 · 12:00"},{type:"tennis",cal:true,text:"Tennis 🎾 · court 3 · unconfirmed · 18:00"},{type:"plan",text:"Z2 run 40min · evening"}] },
