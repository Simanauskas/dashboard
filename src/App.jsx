...
const LAST_RUN  = "2026-09-25T14:46:00Z";
const LAST_DATA = "2026-09-25T14:46:00Z";
...
const SCHEDULE = [
  ...
  { week:4, label:"Sep 28–Oct 4", theme:"Base I · Benchmarks", days:[
    ...
    { date:"2026-09-29", dow:"TUE", label:"Sep 29", sessions:[{type:"tennis",cal:true,text:"Padel 🎾 · 12:00"},{type:"tennis",cal:true,text:"Tennis 🎾 · court 3 · 18:00"},{type:"plan",text:"Z2 run 40min · evening"}] },
